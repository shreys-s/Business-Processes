...
//Hire To Retire
                    ...
                    data: [{
                        ...
                        showInLegend: true, 
                        dataPoints:[
                            { label: "Billing", y: user.h2r.hiring },
                            { label: "Cash Application & Collection", y: user.h2r.employeemanagement },
                            { label: "Credit Analysis", y: user.h2r.payroll },
                            { label: "GL Posting & Reporting", y: user.h2r.retire }
                        ]
                    },
                    {
                        type: "column", 
...
//MaturityData for P2P
        ...
        var tick = {};
        tick.plot0 = user.p2p.score; //put score
...
//MaturityData for O2c
        ...
        var tick = {};
        tick.plot0 = user.o2c.score; //put score
        callback(JSON.stringify(tick));
        };
        var myConfig2 = {
            type: "gauge",
...
//Maturity Data for H2R
        ...
        var tick = {};
        tick.plot0 = user.h2r.score; //put score
        callback(JSON.stringify(tick));
        };
        var myConfig3 = {
            type: "gauge",
