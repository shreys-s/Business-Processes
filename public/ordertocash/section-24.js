...
function loadNextQuestion(){
    ...
    if(currentIndex == totQuestions){
        ...
        resultCont.textContent = 'GL Posting assessment completed | Click Submit to proceed to the Next Section.';
        return; 
    }
...
function submitAnswers(){
    ...
    $.ajax({
        type: "POST",
        url: "http://localhost:3000/assessment/ordertocash/glposting",
